...
function getRealIndex(values, quantities, index){
	let realI = 0;
...
function getNumberOfNonOutliers(someArray, quantities) {
    ...
    var q1 = getRealIndex(values, quantities, Math.floor((sums/ 4)));
    var q3 = getRealIndex(values, quantities, Math.ceil((sums * (3 / 4))));
    var iqr = q3 - q1;
